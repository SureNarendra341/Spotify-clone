...
const AddSong = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setAlbum("none");
                setImage(false);
                setSong(false); // Fixed typo here: setSong instead of setSont
            }else{
    ...
    const loadAlbumData = async () => {
        try {
          ...
          toast.error("Error occurred"); // Corrected error message
        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
            <div className='flex gap-8'>
                <div className='flex flex-col gap-4'>
                    ...
                    <label htmlFor="song">
                        <img src={song ? assets.upload_added : assets.upload_song} className='w-24 cursor-pointer' alt="" /> {/* Corrected className */}
                    </label>
                </div>
                <div className='flex flex-col gap-4'>
                    <p>Upload Image</p>
            ...
            <div className='flex flex-col gap-2.5'>
                <p>Album</p>
                <select onChange={(e) => setAlbum(e.target.value)} defaultValue={album} className='bg-tarnsparent outline-green-600 border-2 border-gray-400 p-2.5 w-[150px]'>
...
export default AddSong; // Don't forget to export!
